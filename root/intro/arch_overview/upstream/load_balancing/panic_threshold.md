Panic threshold {#arch_overview_load_balancing_panic_threshold}
===============
...
hosts. This is known as the *panic threshold*. The default panic
...
+----------+----------+-----------+----------+-----------+-----------+
| P=0      | Traffic  | P=0 in    | Traffic  | P=1 in    | n         |
| healthy  | to P=0   | panic     | to P=1   | panic     | ormalized |
| e        |          |           |          |           | total     |
| ndpoints |          |           |          |           | health    |
+==========+==========+===========+==========+===========+===========+
| 72%      | > 100%   | NO        | > 0%     | NO        | > 100%    |
...
+---------+---------+-------+----------+-------+----------+----------+
| P=0     | P=1     | Tr    | P=0 in   | Tr    | P=1 in   | no       |
| healthy | healthy | affic | panic    | affic | panic    | rmalized |
| en      | en      | to    |          | to    |          | total    |
| dpoints | dpoints | P=0   |          | P=1   |          | health   |
+=========+=========+=======+==========+=======+==========+==========+
| 72%     | > 72%   | >     | NO       | > 0%  | NO       | > 100%   |
|         |         |  100% |          |       |          |          |
+---------+---------+-------+----------+-------+----------+----------+
